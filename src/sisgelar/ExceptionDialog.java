...
public class ExceptionDialog extends JDialog {
	...
	private JButton viewButton = new JButton("Mostrar detalhes");
	...
	public void setupUI() {
		...
		exceptionTextArea.setPreferredSize(new Dimension(200, 100));
	...
	private void setUpListeners() {
		...
		viewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (open) {
					viewButton.setText("Mostrar detalhes");
					...
					viewButton.setText("Ocultar detalhes");
