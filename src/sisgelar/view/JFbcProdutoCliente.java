 ...
 */
public class JFbcProdutoCliente extends javax.swing.JFrame {
...
//        bcPessoas.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFbcProdutoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
               new JFbcProdutoCliente().setVisible(true);
            }
        });
